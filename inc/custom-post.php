...
function post_type_livre()
{
	...
	$args = [
		...
		"labels" => $labels,
		"supports" => [],
		"taxonomies" => ["collections", " thematiques", " auteurs"],
		"hierarchical" => false,
		"public" => true,
		"show_ui" => true,
		"show_in_menu" => true,
...
function custom_taxonomy_thematiques()
{
	$labels = [
		...
		"choose_from_most_used" => __(
			"Choisir parmis les plus utilisés",
			"tompousse"
		),
	...
	register_taxonomy("thematiques", ["livre"], $args);
}
...
function custom_taxonomy_collections()
{
	$labels = [
		...
		"add_or_remove_items" => __(
			"Ajouter ou retirer une collection",
			"tompousse"
		),
		"choose_from_most_used" => __(
			"Choisir parmis les plus utilisées",
			"tompousse"
		),
	...
	register_taxonomy("collections", ["livre"], $args);
}
...
function custom_taxonomy_auteurs()
{
	$labels = [
		...
		"separate_items_with_commas" => __(
			"Séparer les auteurs par des virgules",
			"tompousse"
		),
		"add_or_remove_items" => __(
			"Ajouter ou supprimer un(e) auteur(e)",
			"tompousse"
		),
		"choose_from_most_used" => __(
			"Choisir parmis les plus populaires",
			"tompousse"
		),
	...
	register_taxonomy("auteurs", ["livre"], $args);
}
add_action("init", "custom_taxonomy_auteurs", 0);

/**
 * Register Custom Post Type Compléments
 */
function post_type_complement()
{
	$labels = [
		"name" => _x("Compléments", "Post Type General Name", "tompousse"),
		"singular_name" => _x(
			"Complément",
			"Post Type Singular Name",
			"tompousse"
		),
		"menu_name" => __("Compléments", "tompousse"),
		"name_admin_bar" => __("Page compléments", "tompousse"),
		"archives" => __("Archives", "tompousse"),
		"attributes" => __("Item Attributes", "tompousse"),
		"parent_item_colon" => __("Parent Item:", "tompousse"),
		"all_items" => __("Toutes les pages compléments", "tompousse"),
		"add_new_item" => __("Ajouter une page compléments", "tompousse"),
		"add_new" => __("Ajouter une page compléments", "tompousse"),
		"new_item" => __("Nouvelle page compléments", "tompousse"),
		"edit_item" => __("Modifier la page compléments", "tompousse"),
		"update_item" => __("Mettre à jour la page compléments", "tompousse"),
		"view_item" => __("Voir la page compléments", "tompousse"),
		"view_items" => __("Voir les pages compléments", "tompousse"),
		"search_items" => __("Rechercher une page compléments", "tompousse"),
		"not_found" => __("Rien trouvé", "tompousse"),
		"not_found_in_trash" => __("Rien dans la corbeille", "tompousse"),
	...
	$args = [
		"label" => __("complement", "tompousse"),
		"description" => __("Compléments téléchargeables", "tompousse"),
		"labels" => $labels,
		"supports" => [],
		"taxonomies" => [],
		"hierarchical" => false,
	...
	register_post_type("complement", $args);
}
add_action("init", "post_type_complement", 0);
